...
clash在2020年6月27日更新到1.0.0[版本](https://github.com/Dreamacro/clash/releases/tag/v1.0.0)，这同时也意味着开源时代的结束。此后clash将另开一个闭源版本，称为Premium内核，支持rule provider、tun等新功能。此举封死了clashr无脑抄代码的路子，但也堵死了开源合作的可能性。对于使用者而言，倒是影响不大。
